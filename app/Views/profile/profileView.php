...
<h5 class="card-header d-flex justify-content-between align-items-center py-3">
    <div class="d-flex align-items-center">
        <span class="me-1"><?= swarm_icon('lucide:square-user') ?></span>
        <span class="fw-semibold"><?= hs($username) ?></span></span>
    </div>

    <a href="<?= APP_ADMIN_URL ?>/dashboard" class="btn btn-outline-primary">
        <div class="d-flex align-items-center">
            <span class="me-1"><?= swarm_icon('tabler:arrow-back') ?></span>
